...
<style>
    ...
    .sipkam-inventory-page {
        ...
        background: linear-gradient(180deg, var(--sipkam-soft-2) 0%, #E5F3E7 40%, var(--sipkam-soft-1) 100%);
    }

    body.sipkam-dark .sipkam-inventory-page {
        background: radial-gradient(circle at top, var(--sipkam-deep-1) 0%, var(--sipkam-deep-2) 40%, var(--sipkam-deep-3) 100%);
    }
